...
demo_notes <- read.csv("../anonymized_data/demo_notes.csv", header=T, sep=",")
stress <- read.csv("../anonymized_data/controllability_task.csv", header=T, sep=",")
ratings <- read.csv("../anonymized_data/ratings.csv", header=T, sep=",")
betas <- read.csv("../anonymized_data/MR_betas.csv", header=T, sep=",") 
hr <- read.table("../anonymized_data/heart_rate.csv", header=T, sep=",")
