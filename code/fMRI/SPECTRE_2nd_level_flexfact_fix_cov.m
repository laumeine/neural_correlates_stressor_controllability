%SPECTRE Second Level FlexFact - fixation phase
...
outdir  = ['P:\Psychologie\Spectre\SPECTRE\MRI_data\4_second_level\flexfact_fix_cov'];
...
for i=1:length(sublist)    
    subRNR      = i; %subject running number
    sub         = sublist(i);
    substr      = sprintf('%02d',sub);  
    matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(subRNR).scans = {
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0004.nii,1']; % con fix run1
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0005.nii,1']; % noc fix run1
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0006.nii,1']; % bas fix run1
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0016.nii,1']; % con fix run2
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0017.nii,1']; % noc fix run2
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0018.nii,1']; % bas fix run2
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0028.nii,1']; % con fix run3
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0029.nii,1']; % noc fix run3
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0030.nii,1']; % bas fix run3
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0040.nii,1']; % con fix run4
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0041.nii,1']; % noc fix run4
        ['P:\Psychologie\Spectre\SPECTRE\MRI_data\3_first_level\' num2str(sub) filesep 'beta_0042.nii,1']; % bas fix run4
        };
...
matlabbatch{1}.spm.stats.factorial_design.des.fblock.maininters{1}.fmain.fnum   = 1; %main effect
...
matlabbatch{1}.spm.stats.factorial_design.multi_cov.files = {'P:\Psychologie\Spectre\SPECTRE\Scripts\04_Second_Level\Covariates\stressDur.csv'}; % add stress duration as covariate
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'con_fix_vs_noc_fix';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1 0];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'noc_fix_vs_con_fix';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [-1 1 0];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'stress_fix_vs_bas_fix';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [1 1 -2];
matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'bas_fix_vs_stress_fix';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [-1 -1 2];
matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'con_fix_vs_bas_fix';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [1 0 -1];
matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'noc_fix_vs_bas_fix';
